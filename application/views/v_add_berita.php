                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown dropdown-user">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li><a href="form_inputs_basic.html#"><i class="icon-switch2"></i> Logout</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
            ...
            <div class="content-wrapper">
                ...
                <div class="panel panel-flat">
                    ...
                    <div class="panel-body">
                        <form method="post" class="form-horizontal" action="<?php echo base_url() ?>Berita/simpan_berita">
                            <fieldset class="content-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input name="xnama_lengkap" type="text" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input name="xtgl_lahir" type="date" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input name="xalamat" type="text" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input name="xemail" type="text" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input name="xjabatan" type="text" class="form-control">
                                    </div>
                                </div>
                            </fieldset>
